...
const liveHistory = new mongoose.Schema(
  {
    ...
    liveFollowCount: { type: Number, default: 0 }, //how many followed in live [followed count]
    totalCoinsEarned: { type: Number, default: 0 }, //how many coin earned [total coin earned]
