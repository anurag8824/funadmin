...
//get pk request
route.get("/fetchPkInvitations", checkAccessWithSecretKey(), liveUserController.fetchPkInvitations);

//get live summary
route.get("/fetchLiveAnalytics", checkAccessWithSecretKey(), liveUserController.fetchLiveAnalytics);
