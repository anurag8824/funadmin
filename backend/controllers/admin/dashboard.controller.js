...
exports.dashboardCount = async (req, res) => {
  try {
    ...
    const [totalVideos, totalPosts, totalUsers, totalActiveUsers, totalVerifiedUsers, totalSongs, totalVerificationRequests, totalReports] = await Promise.all([
      Video.countDocuments(dateFilterQuery),
      Post.countDocuments(dateFilterQuery),
      User.countDocuments(dateFilterQuery),
      User.countDocuments({ ...dateFilterQuery, isFake: false, isBlock: false }),
      User.countDocuments({ ...dateFilterQuery, isVerified: true }),
