        ...
        ChatTopic.aggregate([
          ...
          },
          {
            $group: {
              ...
              messageType: { $first: "$chats.messageType" },
              lastMessageImage: { $first: "$chats.image" },
              lastMessageVideo: { $first: "$chats.video" },
              lastMessageThumbnail: { $first: "$chats.thumbnail" },
